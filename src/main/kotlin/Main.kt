    ...
    fun doMain(args: Array<String>) {
        ...
        while (line != null) {
            ...
            if (outputFile.isNullOrEmpty()) {
                print(cutLine)
                if (reader?.ready() == true) { // провер€ем, €вл€етс€ ли строка последней в файле
                    print("\n") // если нет, добавл€ем символ новой строки
                }
            } else {
...
//в качестве параметра дл€ range использовать длинное тире "Ч"
fun main(args: Array<String>) {
    val arguments = arrayOf("-c", "-o", "src\\main\\kotlin\\output.txt", "src\\main\\kotlin\\input.txt", "4Ч8")
